...
export default function Signup() {
    ...
    return (
        <div
            className="shadow-input mx-auto w-full max-w-sm rounded-xl border border-zinc-400 p-4 md:rounded-2xl md:p-8 z-10 bg-[#111]">
            ...
            <form className="my-8" onSubmit={handleSubmit}>
                <div
                    ...
                    <LabelInputContainer>
                        ...
                        <Input id="firstname" placeholder="Tyler" type="text" onChange={(e) => setFName(e.target.value)} value={fName} required />
                    </LabelInputContainer>
                    <LabelInputContainer>
                        <Label htmlFor="lastname">Last name</Label>
                        <Input id="lastname" placeholder="Durden" type="text" onChange={(e) => setLName(e.target.value)} value={lName} required/>
                    </LabelInputContainer>
                </div>
