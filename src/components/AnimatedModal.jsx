            ...
            {open && (
                <motion.div
                    ...
                    <motion.div
                        ref={modalRef}
                        className={cn(
                            "min-h-auto lg:max-w-[30%] md:max-w-[50%] bg-white dark:bg-gray-800 border border-transparent border-gray-600 md:rounded-2xl relative z-50 flex flex-col flex-1 overflow-hidden",
                            className
                        )}
                        initial={{
                            opacity: 0,
